...
var redditApi_1 = __webpack_require__(4);
var dropboxApi_1 = __webpack_require__(3);
var SnooShelf = (function () {
    ...
    SnooShelf.prototype.fetchShelf = function () {
        ...
        return es6_promise_1.Promise.all([subsPromise, postsPromise, tagsPromise, taggedPostsPromise])
    ...
    SnooShelf.prototype.saveShelf = function () {
        ...
        return es6_promise_1.Promise.all([tagsPromise, taggedPostsPromise])
    ...
    SnooShelf.prototype.run = function () {
        var api = new redditApi_1.RedditApi(redditConfig);
        api.getMySubscriptions().then(function (val) { return console.log(val[0].display_name_prefixed); });
        api.getMySavedPosts().then(function (val) { return console.log(val[0].title); });
        var persistence = new dropboxApi_1.DropboxApi(dropboxConfig);
        persistence
            .write("test", "{ \"id\": 1, \"name\": \"A green door\", \"price\": 12.50, \"tags\": [\"home\", \"green\"] }")
            .then(function (val) { return console.log(val); });
        persistence
            .read("test")
            .then(function (val) { return console.log(val.fileBinary); });
    };
    return SnooShelf;
}());
